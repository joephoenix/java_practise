package phoenix.practise.fifthUpperPart.F12;
...
public class EditPanel extends JFrame {
	...
	class OpenAction extends AbstractAction { // 打开文件命令
		...
		public void actionPerformed(ActionEvent e) {
			int i = fileChooser.showOpenDialog(EditPanel.this); // 显示打开文件对话框
	...
	class SaveAction extends AbstractAction { // 保存命令
		...
		public void actionPerformed(ActionEvent e) {
			int i = fileChooser.showSaveDialog(EditPanel.this); // 显示保存文件对话框
	...
	class AboutAction extends AbstractAction { // 关于选项命令
		...
		public void actionPerformed(ActionEvent e) {
			JOptionPane.showMessageDialog(EditPanel.this, "简单的文本编辑器演示"); // 显示软件信息
		}
	}
